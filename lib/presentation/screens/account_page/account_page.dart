...
class _AccountPageState extends State<AccountPage>
  ...
  Widget build(BuildContext context) {
    final accountPageController = Provider.of<AccountPageController>(context);
    ...
    return Scaffold(
                        ...
                        child: TabBarView(
                          ...
                          children: [
                            ...
                            accountPageController.isLoadingTimeline
                                ...
                                : accountPageController.timelinePosts.isEmpty
                                    ? Center(
                                    ...
                                    : RefreshIndicator(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            final post = accountPageController
                                                .timelinePosts[index];
                                            return PostsWidget(
                                              post: post,
                                              isLikedNotifiers:
                                              ...
                                              likesNotifier:
                                                  accountPageController
                                                      .likesNotifier,
                                              commentsMap: accountPageController
                                                  .commentsMap,
                                              profileImage:
                                                  accountPageController
                                                      .profileImage,
                            ...
                            accountPageController.isLoadingCommunity
                                ? const Center(
                                    child: CircularProgressIndicator(
                                        color: Color(0xFF500450)))
                                : accountPageController.communityPosts.isEmpty
                                    ? Center(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: 'profile_fab',
        onPressed: () {
          showCreateOptions(context, accountPageController.resetHasFetchedData);
        },
